...
export default function CalcData1Page() {
  ...
  // Calculate section properties for display
  const maxDim = Math.max(H1, H2, B1, B2);
  const scale = 144 / maxDim * 0.85;
        ...
        <div className="main-grid">
          ...
          <div className="diagram-section">
            ...
            <div className="cross-section">
              <div className="h1-web" style={{ width: `${Math.max(tw1 * scale, 2)}px`, height: `${H1 * scale}px`, left: `${84 - Math.max(tw1 * scale, 2) / 2}px`, top: `${84 - H1 * scale / 2}px` }}></div>
              <div className="h1-flange-top" style={{ width: `${B1 * scale}px`, height: `${Math.max(tf1 * scale, 3)}px`, left: `${84 - B1 * scale / 2}px`, top: `${84 - H1 * scale / 2}px` }}></div>
              <div className="h1-flange-bottom" style={{ width: `${B1 * scale}px`, height: `${Math.max(tf1 * scale, 3)}px`, left: `${84 - B1 * scale / 2}px`, top: `${84 + H1 * scale / 2 - Math.max(tf1 * scale, 3)}px` }}></div>
              <div className="h2-web" style={{ width: `${H2 * scale}px`, height: `${Math.max(tw2 * scale, 2)}px`, left: `${84 - H2 * scale / 2}px`, top: `${84 - Math.max(tw2 * scale, 2) / 2}px` }}></div>
              <div className="h2-flange-left" style={{ width: `${Math.max(tf2 * scale, 3)}px`, height: `${B2 * scale}px`, left: `${84 - H2 * scale / 2}px`, top: `${84 - B2 * scale / 2}px` }}></div>
              <div className="h2-flange-right" style={{ width: `${Math.max(tf2 * scale, 3)}px`, height: `${B2 * scale}px`, left: `${84 + H2 * scale / 2 - Math.max(tf2 * scale, 3)}px`, top: `${84 - B2 * scale / 2}px` }}></div>
