...
export default function UserGuidePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#667eea] to-[#764ba2] p-5 font-['Segoe_UI',_Arial,_sans-serif]">
      <div className="max-w-[1400px] mx-auto bg-white rounded-[20px] shadow-[0_20px_60px_rgba(0,0,0,0.3)] overflow-hidden">
        <div className="bg-gradient-to-br from-[#1e3a5f] to-[#2d5a87] text-white p-10 text-center">
          <h1 className="text-[46.8px] font-bold mb-2.5 tracking-[-0.5px]">📘 K-COL 기능 설명서</h1>
          <p className="text-[23.4px] opacity-90 font-light">Cross H형 강재 기둥 설계 및 제작 관리 시스템</p>
          <Link
            href="/"
            className="inline-block mt-5 px-5 py-2.5 bg-white/20 text-white no-underline rounded-lg transition-all duration-300 border border-white/30 hover:bg-white/30 hover:-translate-y-0.5"
          >
            🏠 홈으로 돌아가기
          </Link>
        </div>
        ...
        <div className="p-[50px_40px] bg-gradient-to-b from-[#f8fafc] to-white">
          <div className="bg-gradient-to-br from-[#f0f4ff] to-white rounded-[16px] p-[30px] mb-[50px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] border-2 border-[#e2e8f0]">
            <h2 className="text-[28.08px] font-bold text-[#1e3a5f] mb-5 pb-[15px] border-b-[3px] border-[#667eea]">
              📑 목차
            </h2>
            <ul className="list-none p-0 m-0">
              {[
                { id: 'top-method', text: '1. TOP-DOWN 공법 (탑다운공법)' },
                { id: 'structure-calculation', text: '2. 구조 계산' },
                { id: 'process-system', text: '3. 공정관리시스템(제작+현장설치)' },
                { id: 'mapping', text: '4. 현장기둥설치 Mapping' },
                { id: 'case-studies', text: '5. Cross H 건물 사례' },
                { id: 'highrise-case', text: '6. 초고층 건물 사례' },
                { id: 'factory-photos', text: '7. 공장 사진' },
                { id: 'temporary-construction', text: '8. 가설건축공사' },
                { id: 'cross-h-structural-features', text: '9. Cross H 구조적 특징 및 장점과 CFT 비교' },
              ].map((item) => (
                <li key={item.id} className="mb-3">
                  <a
                    href={`#${item.id}`}
                    className="flex items-center px-[18px] py-3 bg-white rounded-[10px] no-underline text-[#4a5568] text-[19.2px] transition-all duration-300 border-l-4 border-transparent shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:bg-gradient-to-br hover:from-[#667eea] hover:to-[#764ba2] hover:text-white hover:translate-x-[5px] hover:border-[#ffd700] hover:shadow-[0_4px_12px_rgba(102,126,234,0.3)] before:content-['📌'] before:mr-3 before:text-[18px] hover:before:content-['👉']"
                  >
                    {item.text}
                  </a>
                </li>
          ...
          <section
            id="top-method"
            className="mb-20 scroll-mt-5 bg-white rounded-[16px] p-10 shadow-[0_4px_20px_rgba(0,0,0,0.08)] transition-all duration-300 border border-[#e2e8f0] hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)]"
          >
            <div className="mb-[30px]">
              <h2 className="text-[35.1px] font-bold text-[#1e3a5f] mb-[30px] pb-5 border-b-4 border-image-[linear-gradient(90deg,#667eea_0%,#764ba2_100%)_1] relative flex items-center gap-[15px] before:content-[''] before:w-[6px] before:h-10 before:bg-gradient-to-br before:from-[#667eea] before:to-[#764ba2] before:rounded-[3px]">
                1. TOP-DOWN 공법 (탑다운공법)
              </h2>
            </div>
            ...
            <div className="text-[20.8px] leading-[1.9] text-[#4a5568] mb-[25px]">
              ...
              <ul className="ml-5 mb-[25px] pl-5 list-none">
                {[
                  {
                    title: '타설 콘크리트 없음:',
                  ...
                  { title: '공장 제작:', desc: '공장에서 제작되어 현장 시공 시간을 단축할 수 있습니다.' },
                ].map((item, index) => (
                  <li
                    key={index}
          ...
          >
            ...
            <div className="text-[20.8px] leading-[1.9] text-[#4a5568] mb-[25px]">
              ...
              <ul className="ml-5 mb-[25px] pl-5 list-none">
                {[
                  { title: '단면 타입 선택:', desc: 'Rolled H 또는 Pos-H / Built-UP H 중 선택 가능' },
                  {
                    title: '단면 치수 입력:',
                  ...
                  { title: '좌굴 길이 계수:', desc: 'Kx, Ky, Kz 및 횡좌굴 계수(Cb) 설정' },
                  { title: '비지지 길이:', desc: 'Lx, Ly, Lb 입력' },
                  { title: '설계 하중:', desc: '축력(Pu), 휨모멘트(Mux, Muy), 전단력(Vux, Vuy) 입력' },
                  { title: '간편 계산:', desc: '1-Column에 대한 빠른 구조 계산 수행' },
                  { title: '다중 기둥 계산:', desc: '여러 기둥에 대한 일괄 계산 및 결과 비교' },
                ].map((item, index) => (
                  <li
                    key={index}
                    className="relative pl-[35px] mb-[15px] leading-[1.8] before:content-['✓'] before:absolute before:left-0 before:top-0 before:w-6 before:h-6 before:bg-gradient-to-br before:from-[#667eea] before:to-[#764ba2] before:text-white before:rounded-full before:flex before:items-center before:justify-center before:text-[14px] before:font-bold"
            ...
            <div className="text-[20.8px] leading-[1.9] text-[#4a5568] mb-[25px]">
              ...
              <ul className="ml-5 mb-[25px] pl-5 list-none">
                {[
                  { title: '압축력 검토:', desc: 'Pu/φPn (축력에 대한 압축 강도 비)' },
                  { title: '휨모멘트 검토:', desc: 'Mux/φMnx, Muy/φMny (X, Y 방향 휨 강도 비)' },
                  { title: 'P-M-M 조합 검토:', desc: '축력과 휨모멘트의 조합 검토' },
                  { title: '전단력 검토:', desc: 'Vux/φVnx, Vuy/φVny (X, Y 방향 전단 강도 비)' },
                ].map((item, index) => (
                  <li
                    key={index}
                    className="relative pl-[35px] mb-[15px] leading-[1.8] before:content-['✓'] before:absolute before:left-0 before:top-0 before:w-6 before:h-6 before:bg-gradient-to-br before:from-[#667eea] before:to-[#764ba2] before:text-white before:rounded-full before:flex before:items-center before:justify-center before:text-[14px] before:font-bold"
            ...
            <div className="text-[20.8px] leading-[1.9] text-[#4a5568] mb-[25px]">
              ...
              <ol className="ml-5 mb-[25px] pl-5 list-none counter-reset-[step-counter]">
                {[
                  ...
                  <li
                    key={index}
                    className="relative pl-[50px] mb-[18px] leading-[1.8] counter-increment-[step-counter] before:content-[counter(step-counter)] before:absolute before:left-0 before:top-0 before:w-8 before:h-8 before:bg-gradient-to-br before:from-[#1e3a5f] before:to-[#2d5a87] before:text-white before:rounded-[8px] before:flex before:items-center before:justify-center before:text-[16px] before:font-bold before:shadow-[0_2px_8px_rgba(30,58,95,0.3)]"
                  >
                    {item}
                  </li>
                ))}
          ...
          >
            ...
            <div className="text-[20.8px] leading-[1.9] text-[#4a5568] mb-[25px]">
              ...
              <ol className="ml-5 mb-[25px] pl-5 list-none counter-reset-[step-counter]">
                {[
                  '메인 페이지에서 "K-COL Product Schedule" 메뉴를 클릭합니다.',
                  '프로젝트를 선택합니다.',
                  '"일일 입력" 메뉴에서 일일 제작 현황을 입력합니다.',
                  '"공정표" 메뉴에서 전체 공정을 확인하고 선후단계를 파악합니다.',
                  '"운송 차수" 메뉴에서 운송 일정을 관리합니다.',
                  '실시간으로 업데이트되는 공정 현황을 모니터링합니다.',
                ].map((item, index) => (
                  <li
                    key={index}
                    className="relative pl-[50px] mb-[18px] leading-[1.8] counter-increment-[step-counter] before:content-[counter(step-counter)] before:absolute before:left-0 before:top-0 before:w-8 before:h-8 before:bg-gradient-to-br before:from-[#1e3a5f] before:to-[#2d5a87] before:text-white before:rounded-[8px] before:flex before:items-center before:justify-center before:text-[16px] before:font-bold before:shadow-[0_2px_8px_rgba(30,58,95,0.3)]"
          ...
          >
            ...
            <div className="flex gap-[30px] items-start max-md:flex-col">
              <div className="flex-1">
                <div className="text-[20.8px] leading-[1.9] text-[#4a5568] mb-[25px]">
                  <p className="mb-[18px] pl-[10px]">
                    현장 Mapping 기능은 현장에서 기둥 설치 위치를 시각적으로 관리하고 추적할 수 있는 기능입니다. 설치가
                    완료된 기둥과 미완료된 기둥의 설치완료율을 확인하고 완료된 기둥을 Web Page상에서 시각적으로 확인할
                    수 있는 기능을 제공한다.
                  </p>
                </div>
          ...
          >
            ...
            <div className="text-[20.8px] leading-[1.9] text-[#4a5568] mb-[25px]">
              <p className="mb-[18px] pl-[10px]">
                ...
                공장기둥, 기하학적 형태를 지닌 복합시설 등 다양한 건축물에 효과적으로 활용되고 있습니다.
              </p>
            </div>
          ...
          >
            ...
            <div className="text-[20.8px] leading-[1.9] text-[#4a5568] mb-[25px]">
              ...
              <div className="grid grid-cols-4 gap-5 my-[30px] max-md:grid-cols-1">
                {[
                  ...
                  <div
                    key={index}
                    className="bg-white rounded-[16px] overflow-hidden shadow-[0_6px_20px_rgba(0,0,0,0.1)] transition-all duration-300 ease-in-out border-2 border-[#e2e8f0] hover:-translate-y-2 hover:scale-[1.02] hover:shadow-[0_12px_40px_rgba(102,126,234,0.2)] hover:border-[#667eea] p-5 text-center bg-gradient-to-br from-[#f0f4ff] to-white"
                  >
                    <div className="text-[36px] mb-[10px]">{item.icon}</div>
                    <div className="text-[16px] font-bold text-[#1e3a5f] mb-[8px]">{item.title}</div>
                    <div className="text-[15px] text-[#2d3748] whitespace-pre-line">{item.desc}</div>
                  </div>
                ))}
              </div>

              <div className="py-[56px] px-[16px] mt-[50px]">
                <div className="max-w-[1050px] mx-auto">
                  <div className="mb-[30px]">
                    <h2 className="text-[28px] font-bold text-[#1e3a5f] mb-[10px]">🏗️ 구조시스템 핵심 특징</h2>
                    <p className="text-[20.8px] leading-[1.7] opacity-90 mb-[22px]">
                  ...
                  <div className="grid grid-cols-2 gap-[14px] max-md:grid-cols-1">
                    {[
                      ...
                      <article
                        key={index}
                        className="border border-black/10 rounded-[18px] p-[18px] bg-white shadow-[0_2px_14px_rgba(0,0,0,0.06)]"
                      >
                        <h3 className="text-[16px] font-bold text-[#1e3a5f] mb-[10px]">{item.title}</h3>
                        <p className="text-[20.8px] leading-[1.7] opacity-90 m-0">{item.desc}</p>
                      </article>
                    ))}
                  </div>
                </div>
              ...
              <section id="lakhta-gallery" className="py-[40px] px-[16px] text-center mt-[50px]">
                ...
                <div className="mt-[30px] text-center">
                  <a
                    ...
                    className="inline-block px-6 py-3 bg-[#1e3a5f] text-white no-underline rounded-lg font-bold transition-all duration-300 hover:bg-[#2d5a87]"
                  >
          ...
          >
            ...
            <div className="text-[20.8px] leading-[1.9] text-[#4a5568] mb-[25px]">
              <p className="mb-[18px] pl-[10px]">
                Cross H형 강재 기둥의 구조적 특징을 분석하고, CFT(Concrete Filled Tube) 기둥과 비교하여 각 공법의 특성과
                적용 범위를 명확히 파악할 수 있습니다.
              </p>
            </div>
            ...
            <div className="text-[20.8px] leading-[1.9] text-[#4a5568] mb-[25px]">
              ...
              <ul className="ml-5 mb-[25px] pl-5 list-none">
                {[
                  ...
                  { title: '공기 단축:', desc: '볼트 체결 방식으로 현장 용접 대비 공기 단축이 가능합니다.' },
                  {
                    title: '품질 관리 용이:',
            ...
            <div className="my-[30px] p-[30px] bg-gradient-to-br from-[#f8fafc] to-white rounded-[16px] shadow-[0_8px_24px_rgba(0,0,0,0.1)] border-2 border-[#e2e8f0]">
              ...
              <table className="w-full border-separate border-spacing-0 my-[30px] text-[20.8px] rounded-[12px] overflow-hidden shadow-[0_4px_16px_rgba(0,0,0,0.1)] table-fixed">
                <thead>
                  <tr>
                    <th className="bg-gradient-to-br from-[#1e3a5f] to-[#2d5a87] text-white p-[18px_20px] text-left font-bold uppercase tracking-[0.5px] text-[19.2px] relative w-1/4 rounded-tl-[12px]">
                      📋 항목
                    </th>
                    ...
                    <th className="bg-gradient-to-br from-[#f59e0b] to-[#d97706] text-white p-[18px_20px] text-left font-bold uppercase tracking-[0.5px] text-[19.2px] relative w-[37.5%] rounded-tr-[12px]">
                      🏢 CFT
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    { item: '구조 성능', crossH: '✅ X, Y방향 동일한 성능', cft: '원형/사각형 단면' },
                    { item: '시공 방법', crossH: '✅ 볼트체결(저비용)', cft: '⚠️ 현장용접이음(고비용)' },
                    { item: '콘크리트 타설', crossH: '✅ 불필요', cft: '⚠️ 필요' },
                    { item: '공기', crossH: '✅ 단축 가능', cft: '⚠️ 콘크리트 양생 시간 필요' },
                    {
                      item: '서비스 홀 시공',
                      crossH: '✅ 무타설로 불필요',
                      cft: '⚠️ CFT내채움 콘크리트로 필요',
                    },
                    { item: '부력방지', crossH: '✅ 선단부 오픈으로 불필요', cft: '⚠️ 부력방지대책필요' },
                    { item: '동절기 공사', crossH: '✅ 우수', cft: '⚠️ 콘크리트 타설 제약' },
                    {
                      item: '품질 관리',
                      crossH: '✅ 공장 제작으로 일정',
